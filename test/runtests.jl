...
@testset "GraphsMatching" begin
    ...
    @testset "minimum_weight_perfect_matching" begin
        ...
        wdict = Dict(Edge(1, 2) => 500)
        g = Graph(2)
        add_edge!(g, 1, 2)
        match = minimum_weight_perfect_matching(g, wmat)
        @test match.mate[1] == 2
        match = minimum_weight_perfect_matching(g, wdict)
        @test match.mate[1] == 2
        ...
        match = minimum_weight_perfect_matching(g, wmat, 50)
        @test match.mate[1] == 4
        @test match.mate[4] == 1
        @test match.mate[2] == 3
        @test match.mate[3] == 2
        ...
        g = complete_graph(4)
        match = minimum_weight_perfect_matching(g, wdict, 50)
        @test match.mate[1] == 4
        @test match.mate[4] == 1
        @test match.mate[2] == 3
        @test match.mate[3] == 2
